...
// The footer's three icons are Feather's (MIT; see LICENSE), which is what the applications hosting this
...
const UNDO_SVG = FEATHER(
  '<polyline points="1 4 1 10 7 10"/><path d="M3.51 15a9 9 0 1 0 2.13-9.36L1 10"/>');

const FILE_DOWNLOAD_SVG = FEATHER(
  '<path d="M21 15v4a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-4"/><polyline points="7 10 12 15 17 10"/>'
  + '<line x1="12" y1="15" x2="12" y2="3"/>');

const FILE_UPLOAD_SVG = FEATHER(
