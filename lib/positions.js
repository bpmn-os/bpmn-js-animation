...
export const Position = Object.freeze({
  ...
  ARRIVAL: 'arrival' // left-center "just arrived" rest — an MI outer token with no incoming flow (ad-hoc child)
});
...
const POSITIONS = {
  ...
  // left-edge center, dot straddling the boundary (like a token just arrived at the node)
  [Position.ARRIVAL]:    { left: 0,   top: 0.5, hoffset: 0, voffset: 0 }
};
