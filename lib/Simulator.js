 ...
 * parks the parent, the last consume releases it onto the outflow and travels it). Sub-process entry,
 * event sub-processes, and the event-based-gateway race are upcoming.
 */
