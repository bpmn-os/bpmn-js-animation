 ...
 */
Animation.prototype.moveToFront = function(node, key) {
 ...
 */
Animation.prototype.moveToBack = function(node, key) {
  const order = this._resolveOrder(node);
 ...
 */
Animation.prototype.setStacks = function(node, keys, ancestorStackIndices) {
  this._requireElement(node);
 ...
 * @return {number}
 */
Animation.prototype._stackSize = function(node) {
 ...
 * @return {number}
 */
Animation.prototype.getCurrentStack = function(node) {
  const order = this._resolveOrder(node);
 ...
 */
Animation.prototype.getCurrentStacks = function(node) {
  this._requireElement(node);
 ...
 * @return {Promise<void>}
 */
Animation.prototype._animateStackStep = function(node, element, direction, reorder) {
